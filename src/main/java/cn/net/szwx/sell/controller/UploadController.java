...
import cn.net.szwx.sell.utils.GetServerRealPathUnits;
import cn.net.szwx.sell.utils.ImageUtils;
...
public class UploadController extends BaseController {
    ...
    public JSONObject upload(MultipartFile file, String dir) {
        ...
        String info = "";
        String state = Constants.FAILURE;
        ...
        filePath.append("static/uploads");
        filePath.append("/" + dir);
        ...
        if (Arrays.<String> asList(dirs).contains(dir)) {
            ...
            if (flag) {
                ...
                if (status) {
                    String real = GetServerRealPathUnits.getPath(filePath.toString());
