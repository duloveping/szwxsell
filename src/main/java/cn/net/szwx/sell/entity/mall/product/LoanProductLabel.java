...
public class LoanProductLabel extends EntitySupport {
    /** 所属贷款标签ID */
    ...
    public LoanProductLabel() {
    }

    public LoanProductLabel(Long labelId, Long productId) {
        this.labelId = labelId;
        this.productId = productId;
    }

    public LoanProductLabel(LoanLabel loanLabel, LoanProduct loanProduct) {
